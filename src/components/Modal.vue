...
<!-- Main modal -->
<div :class="{'flex': value === true, 'hidden': value === false}" id="defaultModal" tabindex="-1" class="fixed top-0 left-0 right-0 z-50 w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full justify-center items-center" aria-modal="true" role="dialog">
    <div class="relative w-full max-w-2xl max-h-full">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <!-- Modal body -->
            <div id="canvas-container" ref="container" class="p-6 space-y-6 flex justify-center"></div>
            <!-- Modal footer -->
